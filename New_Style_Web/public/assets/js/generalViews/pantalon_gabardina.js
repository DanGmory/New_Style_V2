import { HOST, URL_PRODUCTS } from '../system/system.js';
    ...
    // URL por defecto
    let href = "#";
    if (category.toLowerCase() === "pantalon" && type.toLowerCase() === "gabardina") {
        href = "../../views/pantalones/pantalonGabardina.html";
    }
    ...
    try {
        ...
        return category === "pantalon" && type === "gabardina";
        });

        if (productosFiltrados.length === 0) {
        container.innerHTML = `<p class="text-warning">No hay productos en categoría PANTALON y tipo GABARDINA.</p>`;
        return;
        }
