...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function handleEditProduct(e) {
        ...
        try {
            const response = await fetch(`${HOST + URL_PRODUCTS}/${productId}`);
    ...
    (async () => {
        await loadOptions(HOST + URL_BRAND, "productBrand", "Brand_id", "Brand_name", brands);
        await loadOptions(HOST + URL_COLORS,"productColor", "Color_id", "Color_name", colors);
        await loadOptions(HOST + URL_SIZE, "productSize", "Size_id", "Size_name", sizes);
        await loadOptions(HOST + URL_TYPE_PRODUCT, "productTypeProduct", "Type_product_id", "Type_product_name", typeProducts);
        await loadOptions(HOST + URL_IMAGE, "productImage", "Image_id", "Image_name", images);
        loadProducts();
    })();
});
