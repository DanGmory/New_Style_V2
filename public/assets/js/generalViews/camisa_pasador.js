    ...
    // URL por defecto
    let href = "#";
    if (category.toLowerCase() === "camisas" && type.toLowerCase() === "pasador") {
        href = "../../views/camisas/camisaPasador.html";
    }
    ...
    try {
        ...
        return category === "camisas" && type === "pasador";
        });

        if (productosFiltrados.length === 0) {
        container.innerHTML = `<p class="text-warning">No hay productos en categoría CAMISAS y tipo PASADOR.</p>`;
        return;
        }
