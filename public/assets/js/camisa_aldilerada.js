    ...
    // URL por defecto
    let href = "#";
    if (category.toLowerCase() === "camisas" && type.toLowerCase() === "alfilerada") {
        href = "../../views/camisas/camisaAlfilereada.html";
    }
    ...
    try {
        ...
        return category === "camisas" && type === "alfilerada";
        });

        if (productosFiltrados.length === 0) {
        container.innerHTML = `<p class="text-warning">No hay productos en categoría CAMISAS y tipo ALFILERADA.</p>`;
        return;
        }
