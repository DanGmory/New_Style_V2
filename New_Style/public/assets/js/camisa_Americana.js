    ...
    // URL por defecto
    let href = "#";
    if (category.toLowerCase() === "camisas" && type.toLowerCase() === "americana") {
        href = "../../views/camisas/camisaAmericana.html";
    }
    ...
    try {
        ...
        return category === "camisas" && type === "americana";
        });

        if (productosFiltrados.length === 0) {
        container.innerHTML = `<p class="text-warning">No hay productos en categoría CAMISAS y tipo AMERICANA.</p>`;
        return;
        }
